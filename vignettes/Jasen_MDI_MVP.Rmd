...
cbind(trim_data$UMCSENT, diffIdx)
...
cbind(trim_data$UMCSENT, y_train)
...
Now, RF model does worse with an MSE of 116 versus 41 for lm in SWFore. However, i suspect look-ahead bias in SWFore. If we dont use lags in our RF model...what are the results?
